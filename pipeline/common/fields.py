...
_SPECS = [
    ...
    _f("has_clawback_policy", bool, None, "P3",
       ...
       "contains the keyword and means the opposite.", ["S04"], snapshot=True),
    _f("has_psu_plan", bool, None, "P3", "Performance share units in the LTI plan", ["S04"], snapshot=True),
    _f("performance_period_years", float, "years", "P3", "LTI performance period", ["S04"], snapshot=True),
    _f("independent_director_count", int, "count", "P3", "Independent directors", ["S04"], snapshot=True),
    _f("board_size", int, "count", "P3", "Total directors", ["S04"], snapshot=True),
