"""S04 — fetch to the L1 raw cache. NO PARSING, NO JSONL.

See SOURCE.md in this folder for the full brief, endpoint and gotchas.

Contract:
  * network in, bytes to cache/raw/S04/ out
...
def pull(ticker_list: list[str] | None = None, *, limit: int | None = None) -> dict:
    ...
    raise NotImplementedError(
        "S04 pull() not implemented -- see SOURCE.md in this folder"
    )


def main() -> None:
    ap = argparse.ArgumentParser(description="S04 pull")
