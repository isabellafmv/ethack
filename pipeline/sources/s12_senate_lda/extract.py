"""S12 — raw cache to Observation records. NO NETWORK.
    ...
    with ObservationWriter(SOURCE) as w:
        for ticker in ticker_list:
            raise NotImplementedError(
                "S12 extract() not implemented. See SOURCE.md in this folder. "
...
def main() -> None:
    ap = argparse.ArgumentParser(description="S12 extract")
